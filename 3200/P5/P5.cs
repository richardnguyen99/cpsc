...
namespace CPSC3200PA5
{
    class P3
    {
        ...
        static int[] GenerateRandomArray(uint count)
        {
            ...
            {
                testArray[i] = RandomNumberIn((int)count * i, (int)count * (i +
1));
            }
            return testArray;
        }
...
* 2;
        ...
        static void TestHeterogeneousCollections()
        {
            ...
            collection[0] = new dataExtractor(minX, minY);
            collection[1] = new dataHalf(minX, minY, maxInvalidReq);
            collection[2] = new dataPlus(minX, minY, kthReq);
            collection[0].InitializeData(testArray1);
            collection[1].InitializeData(testEvenArray);
            collection[2].InitializeData(testArray1);
        ...
        {
            {
                ...
                dataExtractor extractor = new dataExtractor(minX, minY);
            ...
            }
            {
                ...
                int[] array2 = GenerateMockYArray(minY, array1[0]);
                dataHalf half = new dataHalf(minX, minY, maxInvalidRequest);
                half.InitializeData(array1);
                for (int i = 0; i < 33; i++)
                {
                    half.Target(100);
                }
            ...
            }
            {
                ...
                int[] array1 = GenerateRandomArray(minX);
                int[] array2 = GenerateMockYArray(minY, array1[0]);
                dataPlus plus = new dataPlus(minX, minY, kthRequest);
                plus.InitializeData(array1);
...
target[2] + ", " + target[3] + ", " + target[4] + ", " + target[5] + ")");
        ...
        {
            {
                ...
                for (int i = 0; i < number; i++)
                {
                    extractors[i] = new dataExtractor(minX, minY);
                    extractors[i].InitializeData(array2D[i]);
                }
                for (int i = 0; i < number; i++)
                {
                    Console.Write("Array X: ");
            ...
            }
            {
                ...
                for (int i = 0; i < number; i++)
                {
                    halves[i] = new dataHalf(minX, minY, maxRequests);
                    halves[i].InitializeData(array2D[i]);
                }
                for (int i = 0; i < number; i++)
                {
                    Console.Write("Array X: ");
            ...
            }
            {
                ...
                for (int i = 0; i < number; i++)
                {
                    plusses[i] = new dataPlus(minX, minY, kthRequest);
                    plusses[i].InitializeData(array2D[i]);
                }
                for (int i = 0; i < number; i++)
                {
                    Console.Write("Array X: ");
        ...
        {
            Console.WriteLine("-------------------------------- CPSC 3200 P3--------------------------------");
