...
{
    [TestClass]
    public class dataPlusGuardTest
    {
        ...
        public void CorrectInitialization()
        {
            ...
            dataPlusGuard plusGuard = new dataPlusGuard(array, true, 4);

            Assert.AreEqual(plusGuard.Sum(0), 0);
            Assert.AreEqual(plusGuard.Value(4), 5);
        }
        ...
        public void Value()
        {
            ...
            int value = plusGuard.Value(6);
            Assert.AreEqual(7, value);

            plusGuard.Value(10);

            value = plusGuard.Value(6);
        ...
        public void Any()
        {
            ...
            dataPlusGuard plusGuard = new dataPlusGuard(arrayX, true, (int)kth);
        ...
        public void Target()
        {
            ...
            dataPlusGuard plusGuard = new dataPlusGuard(arrayX, true, 4);

            int[] target = plusGuard.Target(3);
