...
{
    [TestClass]
    public class dataPlusSkipGuardTest
    {
        ...
        public void CorrectInitialization()
        {
            ...
            dataPlusSkipGuard plusSkipGuard = new dataPlusSkipGuard(array, true, 4);

            Assert.AreEqual(plusSkipGuard.Sum(0), 0);
            Assert.AreEqual(plusSkipGuard.Value(4), -1);
        }
        ...
        public void Value()
        {
            ...
            dataPlusSkipGuard plusSkipGuard = new dataPlusSkipGuard(array, true, 1);

            int value = plusSkipGuard.Value(6);
            Assert.AreEqual(11, value);

            plusSkipGuard.Value(15);

            value = plusSkipGuard.Value(6);
        ...
        public void Any()
        {
            ...
            dataPlusSkipGuard plusSkipGuard = new dataPlusSkipGuard(arrayX, true, (int)kth);
        ...
        public void Target()
        {
            ...
            dataPlusSkipGuard plusSkipGuard = new dataPlusSkipGuard(arrayX, true, 4);

            int[] target = plusSkipGuard.Target(3);
