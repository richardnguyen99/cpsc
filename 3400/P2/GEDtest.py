...
def runKennedyTests():
    ...
    if doPrint in 'yY':
        print()
        getPerson("I54").printCousins(1)  # Caroline KENNEDY
        print()
        getPerson("I82").printCousins(1)  # Edwin Moore KENNEDY Jr.
        print()
        getPerson("I1").printCousins(1)  # Joseph Patrick Kennedy
        print()
...
filename = input(
    "Type the name of the GEDCOM file or hit Enter to accept default:")
if filename == '':
